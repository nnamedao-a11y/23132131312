...
export default function LegalWorkflowPage() {
  ...
  const tabs = [
    ...
    { id: 'calculations',   label: 'Calculations (P2.7)',   icon: Calculator },
  ];
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-[#71717A]">
            P0.1 Customer Legal · P0.2 Deal Stages · P0.3 Deposit · P0.4 Contracts v2 · P1.2 Financials · P2.7 Calculations
          </p>
        </div>
      </div>
