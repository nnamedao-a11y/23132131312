  ...
  return (
    <section className={[styles.heroContentWrapper, className].join(" ")}>
      <div className={styles.heroContent}>
        ...
        {/* LEFT-HALF DIM OVERLAY — same image, rotated 180deg, 10% opacity.
            Figma spec: width 961.99 / height 1012 / angle -180 / opacity 0.1
            / top 100 / left -1.71. Sits underneath the headline so the
            yellow/white text stays perfectly legible against the dim car.
            Wrapped in a clipping div so overflow doesn't reach dropdowns. */}
        <div className={styles.leftMirrorClip} aria-hidden="true">
          <img
            className={styles.image60Mirror}
            alt=""
            src={heroImage}
            onError={(e) => {
              if (e.currentTarget.src !== window.location.origin + ORIGINAL_HERO.image_url) {
