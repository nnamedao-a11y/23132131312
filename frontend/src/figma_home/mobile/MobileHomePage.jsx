  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ( {t.workingHours}: {siteInfo?.footer?.contacts?.working_hours || t.workingHoursDefault} )
        </div>
...
function MobileSearchFromAmericaKorea() {
  ...
  return (
    ...
    >
      ...
      <AnimatedHeading
        as="h2"
        text={`Search for cars from America and Korea`}
        style={{
          margin: '0 0 28px 0',
          textAlign: 'center',
          fontFamily: FONT,
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: 24 }}>
        ...
        >
          <AnimatedHeading
            as="span"
            text="Top vehicles deals"
            style={{ color: '#FEAE00', display: 'block' }}
          />
          <AnimatedHeading
            as="span"
            text="of the week"
            baseDelay={'Top vehicles deals'.replace(/\s/g, '').length * 28}
        ...
        >
          ...
          >
            ...
            >
              <AnimatedHeading
                as="span"
                text="Calculate a car yourself"
                style={{ color: '#FEAE00', display: 'block' }}
              />
              <AnimatedHeading
                as="span"
                text="with a price guarantee"
                baseDelay={'Calculate a car yourself'.replace(/\s/g, '').length * 28}
                style={{
                  color: '#FFFFFF',
                  display: 'block',
                  marginTop: 4,
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          <AnimatedHeading as="span" text="How to buy" style={{ display: 'block' }} />
          <AnimatedHeading
            as="span"
            text="a turnkey car"
            baseDelay={'How to buy'.replace(/\s/g, '').length * 28}
            style={{ display: 'block' }}
          />
        </h2>
  ...
  return (
    ...
    >
      ...
      >
        <AnimatedHeading
          as="span"
          text="Why you pay less"
          style={{ color: '#FEAE00', display: 'block' }}
        />
        <AnimatedHeading
          as="span"
          text="— and get more"
          baseDelay={'Why you pay less'.replace(/\s/g, '').length * 28}
